...
public class menuAnggota extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Tambah Data Anggota Perpustakaan");
        ...
        jLabel24.setText("Tanggal Bergabung");
            ...
            .addGroup(panelAddLayout.createSequentialGroup()
                .addGroup(panelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panelAddLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtId)
                        .addComponent(txtTlp, javax.swing.GroupLayout.DEFAULT_SIZE, 1086, Short.MAX_VALUE)
                        .addComponent(jLabel21)
                        .addComponent(txtNama, javax.swing.GroupLayout.DEFAULT_SIZE, 1086, Short.MAX_VALUE)
                        .addComponent(jLabel22)
                        .addComponent(txtEmail, javax.swing.GroupLayout.DEFAULT_SIZE, 1086, Short.MAX_VALUE)
    ...
    private void setTableModel() {
        ...
        new Object[]{"ID","Nama","Email","Telepon","Jenis Kelamin","Tanggal Bergabung"},
                0
        );
        ...
        try{
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)){
                ...
                while (rs.next()){
                    ...
                    String jenisKelamin = rs.getString("jns_kelamin");
                    String tanggalBergabung = rs.getString("tgl_bergabung");
    ...
    private void insertData() {
        ...
        String teleponAnggota = txtTlp.getText();
        String jenisKelamin;
        ...
        if(idAnggota.isEmpty()|| namaAnggota.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Semua kolom harus di isi");
            return;
        }
        try {
            String sql = "INSERT INTO anggota (id_anggota,nama_anggota,email,telepon,jns_kelamin,tgl_bergabung) values (?,?,?,?,?,?)";
            PreparedStatement st = conn.prepareStatement(sql);
                ...
                try{
                    ...
                    String tglConvert = toDatabase.format(fromUser.parse(tanggalBergabung));
                    st.setString(6, tglConvert);
