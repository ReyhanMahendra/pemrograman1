 ...
 * @author Infinix
 */
public class menuBuku3 extends javax.swing.JDialog {
    ...
    public menuBuku3(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(menuBuku3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                menuBuku3 dialog = new menuBuku3(new javax.swing.JFrame(), true);
    ...
    private void pilihData() {
            ...
            tahunTerbit = jTable1.getValueAt(row, 3).toString();
